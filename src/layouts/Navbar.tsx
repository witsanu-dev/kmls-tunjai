    ...
    <header className="bg-white border-b border-slate-200 sticky top-0 z-30 shadow-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3 min-w-0 mr-2 sm:mr-4">
          ...
          <div className="flex items-center gap-2.5 sm:gap-3 shrink-0 self-center">
            <div className="bg-gradient-to-br from-teal-600 to-emerald-600 text-white p-2 sm:p-2.5 rounded-lg shadow-sm flex items-center justify-center shrink-0 self-center">
              <Siren className="w-6 h-6 sm:w-7 sm:h-7 animate-pulse" />
            </div>
            <div className="flex flex-col justify-center items-start shrink-0 self-center">
              <div className="flex items-center gap-1.5 leading-none flex-nowrap">
                <h1 className="text-lg sm:text-xl font-black tracking-tight bg-gradient-to-r from-teal-700 via-teal-600 to-emerald-600 bg-clip-text text-transparent leading-none inline-block py-0.5 whitespace-nowrap">
                  ทันใจ
                </h1>
