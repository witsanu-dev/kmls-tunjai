...
// In-memory fallback array in case MySQL is not running yet on the system (Production mode: 0 initial cases)
let memoryCases = [];
...
app.post('/api/settings/moph-notify/test', async (req, res) => {
  const testCase = {
    ...
    age: '65',
    sex: 'ชาย',
    location: 'หน้าตลาดสดกมลาไสย (ต.กมลาไสย อ.กมลาไสย) [EMS]',
